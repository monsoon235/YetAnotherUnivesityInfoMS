...
#加班级
s.post(url+"/api/class/add",json={"id":"0","name":"一班","found_date":"1020-02-02","grade":0,"major_id":"0","charge_teacher_id":"0"})
s.post(url+"/api/class/add",json={"id":"1","name":"二班","found_date":"1020-02-02","grade":0,"major_id":"1","charge_teacher_id":"1"})
s.post(url+"/api/class/add",json={"id":"2","name":"三班","found_date":"1020-02-02","grade":0,"major_id":"2","charge_teacher_id":"2"})
s.post(url+"/api/class/add",json={"id":"3","name":"四班","found_date":"1020-02-02","grade":0,"major_id":"3","charge_teacher_id":"3"})
#加学生
